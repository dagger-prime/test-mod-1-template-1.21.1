...
import daggerprime.testmod1.item.CustomArmorMaterials;
...
public class CustomArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(CustomArmorMaterials.MAGITECH_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.HASTE, 1, 3, false, false),
                                    new StatusEffectInstance(StatusEffects.JUMP_BOOST, 1, 3, false, false))).build();
